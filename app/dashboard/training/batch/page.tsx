  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-futsal-navy">จัดการรุ่นการอบรม</h1>
      ...
      <div className="mt-6">
        ...
        {batches.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            {batches.map((batch) => {
              const participantCount = getParticipantCount(batch);
              const registrationPercentage = (participantCount / batch.maxParticipants) * 100;
                  ...
                  <CardContent className="p-4">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex space-x-1">
                        <Button variant="ghost" size="icon" asChild className="h-8 w-8 text-gray-500 hover:text-futsal-navy">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="text-sm text-gray-700">
                          ...
                          {participantCount >= batch.maxParticipants && 
                            <span className="text-red-500 ml-1">(เต็มแล้ว)</span>
                          }
                        </div>
                      </div>
                    ...
                    <div className="border-t pt-3 flex justify-between items-center">
                      ...
                      <Link href={`/dashboard/training/batch/${batch.id}`}>
                        <Button variant="link" className="text-futsal-blue p-0 h-auto flex items-center">
                          ดูรายละเอียด
