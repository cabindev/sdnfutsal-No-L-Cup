    ...
    sessions: [
      {
        time: "8.00AM - 10.00AM",
        title:
          "Opening Ceremony, FA/AFC Education M&P, History of Futsal, Game Structure Segmentation, Log Book",
        type: "ทฤษฎี",
      },
      {
        time: "10.00AM - 12.00PM",
        title:
          "Warm Up & Cool Down, Basic-Ball Feeling, Basic-Control & Turning, Basic-Passing & Support (VDO, Animation)",
        type: "ทฤษฎี",
      },
      {
        time: "2.00PM - 3.30PM",
        title:
          "Warm Up & Cool Down, Basic-Ball Feeling, Basic-Control & Turning, Basic-Passing & Support",
        type: "ปฏิบัติ",
      },
      {
        time: "4.00PM - 6.00PM",
    ...
    sessions: [
      {
        time: "8.00AM - 10.00AM",
        title:
          "Criteria for Age Group Training 6-18, Planning an Effective Training, Futsal Law of The Game",
        type: "ทฤษฎี",
      },
      {
        time: "10.00AM - 12.00PM",
        title:
          "Basic-Dribbling pass Opponent, Basic-Shooting, System & Style, Basic-Individual Attacking Tactical (VDO, Animation)",
        type: "ทฤษฎี",
      },
      {
        time: "2.00PM - 3.30PM",
      ...
      },
      {
        time: "6.30PM - 9.00PM",
        title:
          "วิทยาศาสตร์การกีฬาและเวชศาสตร์การกีฬา โดย ดร.อัชรัฐ ยงทวี, อาจารย์ณัฐวี แสงอรุณ",
        type: "กลุ่ม",
      },
    ],
  },
    ...
    sessions: [
      {
        time: "8.00AM - 10.00AM",
        title:
          "Futsal Player Qualifications, Coaching Process, Futsal Fitness for Youth, Goal Setting Principles & Motivation",
        type: "ทฤษฎี",
      },
      {
        time: "10.00AM - 12.00PM",
        title:
          "Basic-Defensive Technique (1st,2nd,3rd,4th Defender), Basic-Type of Defense (Man to Man, Alternative,Zone,Mix) (VDO, Animation)",
        type: "ทฤษฎี",
      },
      {
        time: "2.00PM - 3.30PM",
      ...
      },
      {
        time: "6.30PM - 9.00PM",
        title:
          "Day 1 Review & Discussion, Group Presentation (20-40), Homework",
        type: "กลุ่ม",
      },
    ],
  },
    ...
    sessions: [
      {
        time: "8.00AM - 10.00AM",
        title:
          "Requirements to Be a Successful Coach, Coaching Method, Twelve Main Order For Futsal Players",
        type: "ทฤษฎี",
      },
      {
        time: "10.00AM - 12.00PM",
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-futsal-navy">
          <tr>
            ...
            <th
              scope="col"
              className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider w-24"
            >
              ประเภท
            </th>
          </tr>
...
export default function Schedule() {
  ...
  const handleDownloadPDF = () => {
    ...
    link.setAttribute(
      "download",
      "SDN_Futsal_NO-L_T-License_2025_Schedule.pdf"
    );
          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl font-bold text-futsal-navy inline-block pb-2 border-b-4 border-futsal-orange">
                SDN Futsal NO-L{" "}
                <span className="text-futsal-orange">T-License 2025</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mt-4">
                หลักสูตรอบรมผู้ฝึกสอนฟุตซอลระดับ T-License คุณภาพสูง
                ครบถ้วนทั้งภาคทฤษฎีและปฏิบัติ
              </p>
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="flex bg-[#f8fafc] rounded-t-2xl border border-gray-200 overflow-hidden">
            <button
              ...
              className={`flex-1 py-4 px-3 sm:py-5 sm:px-8 text-base font-semibold flex items-center justify-center transition-all ${
                activeTab === "schedule"
            ...
            >
              ...
              <span className="tracking-wide uppercase ml-3 hidden sm:inline">
                TRAINING SCHEDULE
              </span>
            </button>
          ...
          <div className="bg-white rounded-b-2xl shadow-lg border-x border-b border-gray-200">
                  ...
                  <div className="flex items-start gap-2 text-gray-600">
                    ...
                    <div>
                      ...
                      <ul className="mt-1 space-y-1 list-disc ml-4">
                        ...
                        <li>
                          การสอบภาคปฏิบัติจะพิจารณาจากทักษะและความเข้าใจโดยรวม
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <p className="text-gray-600 italic text-sm">
                      * ไม่จำเป็นต้องมีประสบการณ์การเป็นผู้ฝึกสอนมาก่อน
                      เหมาะสำหรับผู้ที่ต้องการเริ่มต้นเป็นโค้ช
                    </p>
                  </div>
                </div>
            ...
            {activeTab === "instructors" && (
              <motion.div
                ...
                className="p-6"
              >
                <h3 className="text-2xl font-bold text-futsal-navy mb-4 pb-2 border-b border-gray-200">
                  ทีมวิทยากรผู้เชี่ยวชาญ
                </h3>

                {/* ลดช่องว่างโดยลบ div ที่ไม่จำเป็นออก */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  {instructors.map((instructor, index) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="bg-white hover:bg-gradient-to-br hover:from-white hover:to-futsal-orange/5 rounded-lg p-5 shadow-sm hover:shadow-md transition-all border border-gray-200"
                    >
                      {/* เส้นด้านบนให้ความสวยงาม */}
                      <div className="h-1 w-16 bg-gradient-to-r from-futsal-orange to-futsal-gold rounded mb-3"></div>

                      {/* ชื่อวิทยากร */}
                      <h5 className="font-semibold text-futsal-navy text-lg">
                        {instructor}
                      </h5>

                      {/* ตำแหน่ง */}
                      <p className="text-futsal-orange/80 text-sm font-medium mt-1">
                        วิทยากรฟุตซอล
                      </p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        <span className="inline-block px-2 py-1 rounded-full text-xs font-medium bg-futsal-orange/10 text-futsal-orange">
                          T-License
                        </span>
                        <span className="inline-block px-2 py-1 rounded-full text-xs font-medium bg-futsal-blue/10 text-futsal-blue">
                          ผู้เชี่ยวชาญ
                        </span>
                      </div>
                    </motion.div>
                ...
                {/* ข้อมูลเพิ่มเติม - ลดช่องว่างด้านบน */}
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
                    ...
                    <h4 className="text-lg font-semibold text-futsal-navy text-center">
                      ประสบการณ์ระดับสูง
                    </h4>
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center">
                    ...
                    <h4 className="text-lg font-semibold text-futsal-navy text-center">
                      การดูแลผู้เรียนอย่างใกล้ชิด
                    </h4>
                    <p className="text-center text-gray-600 mt-2">
                      จำกัดจำนวนผู้เข้าอบรมต่อรุ่น
                      เพื่อการดูแลอย่างทั่วถึงและมีคุณภาพ
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="relative p-8 md:p-10 flex flex-col md:flex-row items-center">
              <div className="w-full">
                ...
                <p className="text-white/90 text-lg text-center">
                  เริ่มต้นเส้นทางการเป็นโค้ชฟุตซอลมืออาชีพกับหลักสูตร T-License
                  ที่ได้รับการยอมรับในวงการกีฬาฟุตซอล
                </p>
              </div>
            </div>
          </div>
